...
if __name__ == "__main__":
    ...
    detection_results_path = '/home/neba/Desktop/Data_Engineering/KAMI/Week-7/Ethiomed-Data-Warehouse/notebooks /yolov5/runs/detect/predictions3/labels' # Path to your labels
